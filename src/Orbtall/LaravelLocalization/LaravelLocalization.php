...
use Orbtall\LaravelLocalization\Exceptions\SupportedLocalesNotDefined;
use Orbtall\LaravelLocalization\Exceptions\UnsupportedLocaleException;
use Orbtall\LaravelLocalization\Models\Locale;
...
class LaravelLocalization
{
    ...
    public function setLocale($locale = null)
    {
        ...
        $language = $this->getCurrentLocaleLanguage();
    ...
    public function getSupportedLocales()
    {
        ...
        if (Schema::hasTable('locales')) {
            ...
            foreach ($locales as $locale) {
                $locales_array[$locale['code']] = array(
                    'name' => $locale['name'],
            ...
            $this->supportedLocales = $locales_array;
    ...
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['native_name'];
    }
     ...
     */
    public function getCurrentLocaleLanguageCode()
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['language_code'];
    }
    ...
    public function getCurrentLocaleLanguage()
    {
        ...
        if (isset($this->supportedLocales[$this->getCurrentLocale()]['language'])) {
